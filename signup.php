...
//validation
 	...
 	if ($insert) {
 		echo "<b>Successfully Registared...</b>";
 	} else {
...
<div class="container">
  ...
  <strong>Warning!</strong> <?php if(isset($trano)){echo '<span>'. $trano.'</span>';}?>
</div><?php }?></center>
  <div class = "frame">
  <h2> SIGN UP </h2>
  <form action="" method="post">
     <input type ="text" name="fname" placeholder ="First Name" value="<?php if(isset($fname)){echo $fname;}?>" required> 
     <?php if(isset($fnmsg)){echo '<span>'. $fnmsg.'</span>';}?>

     <input type ="text" name="lname" placeholder ="Last Name" value="<?php if(isset($lname)){echo $lname;}?>" required >
     <?php if(isset($lnmsg)){echo '<span>'. $lnmsg.'</span>';}?>
     <input type ="tel" name="pnumber" placeholder ="Phone number" value="<?php if(isset($pnumber)){echo $pnumber;}?>" required>
     <?php if(isset($pnmsg)){echo '<span>'. $pnmsg.'</span>';}?>
     <input type ="email" name="email" placeholder ="email" value="<?php if(isset($email)){echo $email;}?>" required>
     <?php if(isset($mlmsg)){echo '<span>'. $mlmsg.'</span>';}?>
     <input type ="password" name="password" placeholder ="password" required>
     <?php if(isset($pamsg)){echo '<span>'. $pamsg.'</span>';}?>
     <input type ="password" name="cpassword" placeholder ="Confirm password" required >
     <?php if(isset($conmsg)){echo '<span>'. $conmsg.'</span>';}?>
