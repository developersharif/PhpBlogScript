...
<div class="container-fluid">
    <div class="row">
                ...
                <div class="list-group ">
                    ...
                    <div class="p-post">
                        <a href="article.php?id=<?php echo $post["id"]; ?>"
                            class="list-group-item list-group-item-action" style="overflow: hidden;">
        ...
        <div class="col-md-6">
            ...
            <!-- Primary Meta Tags -->
            <meta name="title" content="<?php echo $post['title']; ?>">
            <meta name="description" content="<?php echo $settings['site_description']; ?>">
            <!-- Facebook -->
            <meta property="og:type" content="website">
            <meta property="og:title" content="<?php echo $post['title']; ?>">
            <meta property="og:image" content="images/thumb/<?php echo $post['thumb']; ?>">

            <!-- Twitter -->
            <meta property="twitter:card" content="summary_large_image">
            <meta property="twitter:title" content="<?php echo $post['title']; ?>">
            <meta property="twitter:image" content="images/thumb/<?php echo $post['thumb']; ?>">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card author-info">
                        <div class="list-group">
                            <li class="list-group-item">
                                <table>
                                    <tr>
                                        <td><img src="images/profile/<?php echo $post['avatar']; ?>" alt=""
                                                class="avatar"></td>
                                        <td><span><b><?php echo $post["name"] . " " . $post["lname"]; ?></b></span>
                                            <br><?php echo $post["role"]; ?></td>
                                    </tr>
                                </table>
                            </li>
        ...
        <div class="col-md-3">
            ...
            <div class="popular ">
                <div class="border-left ">Suggested</div>
                <div class="list-group ">
                    <?php
                        $post_info = $main->db_query("content", "id", "$postid");
                        $post_cate = $post_info['category'];
                        $post_title = $post_info['title'];
                        $result = $main->select("SELECT content.id,content.uid,content.title,content.thumb,content.category,content.date, content.status,content.views, users.name FROM content INNER JOIN  users ON content.uid=users.id and content.status='published' and content.category='$post_cate' and content.id!='$postid'  ORDER by title asc LIMIT 5");
                    ...
                    <div class="p-post" style="overflow: hidden;">
                        ...
                        <div class="post-info">
                            <div class="row">
                                ...
                                <div class="col small"><i class="fa fa-eye" aria-hidden="true"></i>
                                    <?php echo $format->views($post["views"]); ?></div>
                                <div class="col small"><i class="fa fa-hashtag" aria-hidden="true"></i>
