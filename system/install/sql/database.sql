...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2020 at 06:57 AM
...
INSERT INTO `settings` (`id`, `site_name`, `site_title`, `site_description`, `notice`, `site_logo`, `site_banner`, `site_color`, `font_color`, `dark_mode`, `new_post`, `perpage_post`, `reg_status`, `site_status`, `site_url`, `more`) VALUES
(1, 'Blog', 'Blog Title\r\n\r\n    ', 'Blog description', '', '{\"logo\":\"logo.png\",\"height\":\"50\",\"width\":\"50\"}', 'bannar.png', '#454545', '#ffffff', 'off', 'on', 8, 'on', 'on', '{\"protocol\":\"https://\",\"domain\":\"sharif.com\",\"dirname\":\"/CMS\"}', '{\"host\":\"\",\"username\":\"\",\"password\":\"\",\"port\":\"\"}');
