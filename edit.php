            ...
            <div class="card-body pad">
                        ...
                        <div class="form-group">
                          <div class="col-xs-6">
                            <label for="last_name"><h6>Title</h6></label>
                              ...
                              <input type="text" class="form-control" name="title" id="last_name" placeholder="Title" title="Write your post title" value="<?php echo $post['title'];?>" required="true">
                          </div>
                      </div>
                     <div class="form-group">
                          <div class="col-xs-6">
              ...
              <div class="mb-3">
                ...
                <textarea class="textarea content" id="editor" placeholder="Place some text here" name="content" 
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" value='<?php echo $post["content"]; ?>'  required><?php echo $post['content']; ?></textarea>
              </div>
              <div class="mb-3">
                <label for="content"><h6>Thumbnail</h6></label>
                <input type="file" name="thumb" class="form-control" required="true">
              </div>
