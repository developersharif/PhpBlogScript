...
if( $referer["host"] === $chost){
     try {
        ...
        // $mail->addCC('cc@example.com');
         ...
         $mail->send();
        header("location: ../reset-password.php?check=true");
        exit;
     } catch (Exception $e) {
        header("location: ../reset-password.php?check=false");
        exit;
     }
    }else{
        header("location: ../reset-password.php?check=false");
