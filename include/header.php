...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-inverse navbar-fixed-top"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="nav-item">
                <?php if ($user->check_usr() == false) { ?> <a class="nav-link" href="login" style="color: white">sign
                    in</a><?php } ?>
            </div>
            <div class="nav-item">
                <?php if ($user->check_usr() == false) { ?> <a class="nav-link" href="signup" style="color: white">sign
                    up</a><?php } ?>
            </div>
