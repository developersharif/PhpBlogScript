        ...
        <div class="row">
            ...
            <div class="col-md-6 col-6">
                <div class="list-group">
                    ...
                    <?php if (isset($_COOKIE['c_user'])) { ?> <a href="changepass.php">Change password</a><?php } ?>
                    <?php if (isset($_COOKIE['c_user'])) { ?> <a href="logout.php">Logout</a><?php } ?>
                </div>
            </div>
            <div class="col">
                &nbsp;
                <div class="align-center small">&copy; <?php echo date('Y'); ?> by <?php echo $settings['site_name']; ?>
