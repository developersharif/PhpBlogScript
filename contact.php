...
?>
<title>Contact</title>
<?php if(isset($_GET['s'])){ ?> <center><div class="alert alert-success">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <?php echo $_GET['s'];?></div></center><?php }?>
              ...
              <div class="card-body">
                <form action="" method="post">
                 ...
                 <label for="message"><h6>Message</h6></label>
                  <textarea name="message" placeholder="Write your message" class="form-control" id="message" required></textarea> 
               <?php if($user_cls->check_usr()==false){ ?>
                 <label for="email"><h6>Email</h6></label>
                 <input type="email" class="form-control" name="email" id="email" placeholder="Email" style="color:black"required></input><?php } ?>
