...
<body>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="dropdown-item"
                                                href="?action=pending&id=<?php echo $row['id']; ?>">Pending</a></li>
                                        <li><a class="dropdown-item"
                                                href="?action=ban&id=<?php echo $row['id']; ?>">Ban</a></li>
                                        <li><a class="dropdown-item"
                                                href="?action=delete&id=<?php echo $row['id']; ?>">Delete</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header border-transparent">
                    <h3 class="card-title">
                        <?php echo $post["title"]; ?>>><?php echo $post["category"]; ?>>><?php echo $post["date"]; ?>
                    </h3>
    ...
    $img->compress('thumb', $destination, 30);
