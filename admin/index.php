      ...
      <div class="container-fluid">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo number_format($Published)." of ".$totall_posts; ?></span>
              </div> 
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        ?>
                    ...
                    <tr>
                      ...
                      <td><a href="posts.php?id=<?php echo $row['id'];  ?>"><?php echo $row['title']; ?></a> 
                     </td>
                    ...
                    <ul class="users-list clearfix">
                     ...
                     $query=$main->select("select * from users order by id desc limit 25");
                      ...
                      <li data-toggle="modal" data-target="#<?php echo $row["username"];?>">
                        ...
                        <a class="users-list-name" href="#"><?php echo $row['name']." ".$row['lname'];  ?></a>
                        <span class="users-list-date"><?php echo $format->time_ago($row['reg_date']);?></span>
          ...
          <div class="modal-content">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header bg-info">
                <h3 class="widget-user-username"><?php echo $row['name']." ".$row['lname'];?></h3>
                <h5 class="widget-user-desc"><?php echo $row['role'];?></h5>
              </div>
              <div class="widget-user-image">
                <img class="img-circle elevation-2" src="../images/profile/<?php echo $row['avatar'];?>" alt="User Avatar">
              </div>
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $pub_post; ?></h5>
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $pen_post; ?></h5>
                  ...
                  <div class="col-sm-4">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $ben_post;?></h5>
...
<?php if ($row['role']=='author' OR $row['role']=='subscriber' OR $row['role']=='editor' OR $row['role']=='ban' or $row['role']=='admin') {?>
    <button type="button" class="btn btn-success"><a href="?role=author&id=<?php echo $row['id']; ?>" class="text-white">Make Author</a></button>
  <div class="btn-group">
    <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
     <span class="caret"></span></button>
    <ul class="dropdown-menu" role="menu">
      <li><a class="dropdown-item" href="?role=subscriber&id=<?php echo $row['id']; ?>">Subscriber</a></li>
      <li><a class="dropdown-item" href="?role=editor&id=<?php echo $row['id']; ?>">Editor</a></li>
      <?php if($row['role']!="moderator"){ ?><li><a class="dropdown-item" href="?role=moderator&id=<?php echo $row['id']; ?>">Moderator</a></li><?php } ?>
      <li><a class="dropdown-item" href="?role=admin&id=<?php echo $row['id']; ?>">Admin</a></li>
      <li><a class="dropdown-item" href="?role=ban&id=<?php echo $row['id']; ?>">#Ban</a></li> 
    </ul>
  </div>
<?php }elseif($admin_status=='global admin') {?>
 <button type="button" class="btn btn-primary"><a href="" class="text-white">Global Admin</a></button>
<?php }elseif($row['role']=='moderator'){?>

<button type="button" class="btn btn-danger"><a href="?role=rmod&id=<?php echo $row['id']; ?>" class="text-white">Remove Moderator</a></button>
...
<?php } ?>
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-primary"><a href="" class="text-white">View</a></button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="posts.php?id=<?php echo $post['id'];  ?>" class="product-title"><?php echo $post['title']; ?>
                        <span class="badge badge-info float-right"><?php echo $post['category']; ?></span></a>
