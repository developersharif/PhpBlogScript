          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <div class="float-right">
                <button type="button" class="btn btn-default"><a href="?id=<?php echo $inbox['id']; ?>&reply"><i class="fas fa-reply"></i>Reply</a></button>
              </div>
              <button type="button" class="btn btn-default"><a href="?action=delete&id=<?php echo $inbox['id']; ?>"><i class="far fa-trash-alt"></i> Delete</a></button>
      	...
      	<div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <input class="form-control" name="to" placeholder="To:" value="<?php echo $inbox['email']; ?>">
                </div>
                <div class="form-group">
                  <input class="form-control" name="subject" placeholder="Subject:">
                </div>
                <div class="form-group">
                    <textarea id="compose-textarea" name="body" class="form-control" style="height: 300px" placeholder="Email"></textarea>
                </div>
              </div>
              <!-- /.card-body -->
              <div class="card-footer">
